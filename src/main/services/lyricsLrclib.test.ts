...
test('createLrclibClientHeaders sends current LRCLIB client identity', () => {
  ...
  assert.equal(headers['Lrclib-Client'], 'Musaic/0.5.0 (https://github.com/solder3t/musaic-player-linux)')
...
test('fetchLrclibJson sends LRCLIB client headers', async () => {
  ...
  assert.deepEqual(capturedHeaders, {
    ...
    'Lrclib-Client': 'Musaic/0.5.0 (https://github.com/solder3t/musaic-player-linux)',
    'User-Agent': 'Musaic/0.5.0 (https://github.com/solder3t/musaic-player-linux)'
  })
})
